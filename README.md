Generated with [Bati](https://batijs.dev) ([version 338](https://www.npmjs.com/package/create-bati/v/0.0.338)) using this command:

```sh
bun create bati --react --tailwindcss --shadcn-ui --authjs --hono --prisma --google-analytics --eslint --prettier
```
